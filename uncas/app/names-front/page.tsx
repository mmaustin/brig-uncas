    ...
    <section className="w-full h-[550px]">
      <div className=" w-inherit h-full mx-10 flex flex-col justify-center  md:flex-wrap md:justify-around items-center">
        <div className="flex flex-col justify-center items-center">
          <div className="text-center font-serif italic text-sm rounded-lg w-[275px] sm:w-[400px] md:w-[425px] lg:w-[500px] bg-amber-950/70 border mx-2">No. / Name of Negroes / Age / Feet / Inches / Colour / Remarks</div>
          <Image
        ...
        <section className="h-[250px] w-[200px] my-8 flex justify-center items-center bg-amber-950/70 rounded-lg">
